...
/**
 * binary_trees_ancestor - The val common of the two.
 * @first: first node entry point.
 * @second: second node entry point.
 *
 * Return: common else NULL.
 */
...
/**
 * depth - cal dept of the node.
 * @tree: entry point of th enode.
 *
