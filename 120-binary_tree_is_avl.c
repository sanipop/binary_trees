...
/**
 * height - func compute tree height.
 * @tree: entry point to yree.
 *
...
/**
 * is_avl_helper - status of AVL tree.
 * @tree: entry point to the tree.
 * @lo: current min.
 * @hi: current max.
 *
 * Return: the val else 0 for null.
 */
int is_avl_helper(const binary_tree_t *tree, int lo, int hi)
{
...
/**
 * binary_tree_is_avl - validity if this tree.
